...
class UserService extends ModelService
{
     ...
     */
    protected array $storables = ['username', 'name', 'email', 'phone', 'password', 'role_id', 'status', 'language', 'tap_customer_id', 'cm_firebase_token', "remember_token", "role", "vendor","rewards"];

    /**
     * updatable field is a field which can be filled during updating the record
     */
    protected array $updatables = ['username', 'name', 'email', 'phone', 'password', 'status', 'language', 'cm_firebase_token', "remember_token", 'role',"rewards"];
    ...
    public function pushNotification( $user, $title, $body): void
    {
        ...
        try {
            ...
            if ($user->role == User::ROLE_VENDOR) {
                $this->firebaseService->sendNotificationToAppVendor($message);
